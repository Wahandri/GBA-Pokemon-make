...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("WAHANDRI");
const u8 gText_ExpandedPlaceholder_May[] = _("FRAN");
...
const u8 gText_BirchBoy[] = _("WAHANDRI");
const u8 gText_BirchGirl[] = _("FRAN");

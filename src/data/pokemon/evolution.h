const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_METAGROSS]  = {{0, 0, 0}},
    [SPECIES_GORDA]      = {{EVO_LEVEL, 18, SPECIES_GORDARA}},
    [SPECIES_GORDARA]    = {{EVO_LEVEL, 36, SPECIES_GORDRAGON}},
    [SPECIES_GORDRAGON]  = {{0, 0, 0}},
    [SPECIES_CHARLY]     = {{EVO_LEVEL, 18, SPECIES_CHARLOS}},
    [SPECIES_CHARLOS]    = {{EVO_LEVEL, 36, SPECIES_CHARLORD}},
    [SPECIES_CHARLORD]   = {{0, 0, 0}},
};

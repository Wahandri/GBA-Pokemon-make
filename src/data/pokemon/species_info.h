...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    */
    ...
    [SPECIES_GORDA] =
    {
        ...
        .backPicYOffset = 5,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_Gorda,
        .shinyPalette = gMonShinyPalette_Gorda,
    ...
    [SPECIES_CHARLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FIELD),
        .abilities = { ABILITY_OVERGROW, ABILITY_LIGHTNING_ROD, ABILITY_LIGHTNING_ROD },
        ...
        .backPicYOffset = 5,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_Charly,
        .shinyPalette = gMonShinyPalette_Charly,

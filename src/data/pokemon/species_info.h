...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    */
    ...
    [SPECIES_GORDA] =
    {
        ...
        .speciesName = _("GORDA"),
        .cryId = CRY_GROWLITHE,
        .natDexNum = NATIONAL_DEX_GORDA,
        .categoryName = _("Valiente"),
        .height = 6,
        .weight = 120,
        .description = gGordaPokedexText,
        .pokemonScale = 356,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_Gorda,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_Gorda,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 5,
        .backAnimId = BACK_ANIM_NONE,
        .palette = (const u16 *)gMonPalette_Gorda,
        .shinyPalette = (const u16 *)gMonPalette_Gorda,
        .iconSprite = gMonIcon_Gorda,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-1, 0, SHADOW_SIZE_M)
        FOOTPRINT(Gorda)
    ...
    [SPECIES_CHARLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FIELD),
        .abilities = { ABILITY_OVERGROW, ABILITY_LIGHTNING_ROD, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("CHARLY"),
        .cryId = CRY_MANECTRIC,
        .natDexNum = NATIONAL_DEX_CHARLY,
        .categoryName = _("Alegre"),
        .height = 7,
        .weight = 110,
        .description = gCharlyPokedexText,
        .pokemonScale = 356,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_Charly,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_Charly,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 5,
        .backAnimId = BACK_ANIM_NONE,
        .palette = (const u16 *)gMonPalette_Charly,
        .shinyPalette = (const u16 *)gMonPalette_Charly,
        .iconSprite = gMonIcon_Charly,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-1, 0, SHADOW_SIZE_M)
        FOOTPRINT(Charly)

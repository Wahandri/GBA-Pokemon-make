...
} static const sCursorOptions[] =
{
    ...
    [MENU_FIELD_MOVES + FIELD_MOVE_VIAJAR] = {gMoveNames[MOVE_VIAJAR], CursorCb_FieldMove},
};
...
} static const sFieldMoveCursorCallbacks[FIELD_MOVES_COUNT] =
{
    ...
    [FIELD_MOVE_VIAJAR]       = {SetUpFieldMove_Viajar,      PARTY_MSG_CANT_USE_HERE},
};

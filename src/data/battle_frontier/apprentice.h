...
{
    {
        .name = {"サダヒロ"), _("ALANN"), _("ALAIN"), _("ADELFO"), _("CLAUS"), _("TEO"},
        .otId = 48585,
    ...
    {
        .name = {"ヒロオ"), _("LIONEL"), _("LIONEL"), _("CAIO"), _("LUDWIG"), _("LEO"},
        .otId = 53001,
    ...
    {
        .name = {"ケイジ"), _("SONNY"), _("HERVE"), _("FEDRO"), _("WENZEL"), _("SANTI"},
        .otId = 11828,
    ...
    {
        .name = {"ユラ"), _("LAYLA"), _("LAYLA"), _("ASTRID"), _("SONJA"), _("LOLA"},
        .otId = 34031,
    ...
    {
        .name = {"ヨウカ"), _("MACY"), _("AMELIE"), _("CLEO"), _("MARIA"), _("ELISA"},
        .otId = 7747,
    ...
    {
        .name = {"ヤスシ"), _("DONTE"), _("BRAHIM"), _("GLAUCO"), _("JOSEF"), _("ROQUE"},
        .otId = 14239,
    ...
    {
        .name = {"ミサオ"), _("AMIRA"), _("LAURE"), _("DAFNE"), _("AMELIE"), _("LARA"},
        .otId = 62805,
    ...
    {
        .name = {"カズサ"), _("KALI"), _("JODIE"), _("ILENIA"), _("KARO"), _("ELSA"},
        .otId = 36134,
    ...
    {
        .name = {"スミレ"), _("ANNIE"), _("ANNIE"), _("IMELDA"), _("INES"), _("ROSA"},
        .otId = 32780,
    ...
    {
        .name = {"アキノリ"), _("DILLEN"), _("RENE"), _("INDRO"), _("DETLEF"), _("PEDRO"},
        .otId = 18079,
    ...
    {
        .name = {"トウゾウ"), _("DALLAS"), _("BRUNO"), _("LEARCO"), _("ANSGAR"), _("MANOLO"},
        .otId = 29180,
    ...
    {
        .name = {"セイヤ"), _("FRANK"), _("FRANK"), _("OLINDO"), _("FRANK"), _("MAURO"},
        .otId = 41886,
    ...
    {
        .name = {"リュウジ"), _("LAMONT"), _("XAV"), _("ORFEO"), _("JÜRGEN"), _("JORGE"},
        .otId = 58768,
    ...
    {
        .name = {"カツアキ"), _("TYRESE"), _("ANDY"), _("PARIDE"), _("DAVID"), _("CHICHO"},
        .otId = 53272,
    ...
    {
        .name = {"トシミツ"), _("DANTE"), _("DANTE"), _("RAOUL"), _("LOTHAR"), _("PABLO"},
        .otId = 48245,
    ...
    {
        .name = {"ローウェン"), _("ARTURO"), _("ARTURO"), _("ROMOLO"), _("BRIAN"), _("ARTURO"},
        .otId = 64002,
